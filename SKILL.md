...
4. `dist/color-certification-exam-trainer-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md` を release asset として添付する。
5. QCDSは docs と ZIP の存在確認だけで通さず、問題データ、採点、復習、教材更新方針、手動テスト手順を必須とする。
